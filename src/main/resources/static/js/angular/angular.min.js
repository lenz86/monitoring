...
(function (A) {
    ...
    function Pc(a, b) {
        ...
        var e = {}, g = /^\s*directive:\s*([\w-]+)\s+(.*)$/, h = /(([\w-]+)(?::([^;]+))?;?)/,
            k = le("ngSrc,ngSrcset,src,srcset"), l = /^(?:(\^\^?)?(\?)?(\^\^?)?)?/,
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$templateRequest", "$parse", "$controller", "$rootScope", "$sce", "$animate", "$$sanitizeUri", function (a,
            ...
            function ga(a, b, d, e, g, h, k, l) {
                var m = [], n, p, K = b[0], t = a.shift(),
                    s = Tb(t, {templateUrl: null, transclude: null, replace: null, $$originalDirective: t}),
    ...
    function qg(a, b, d, c, f) {
        ...
        return function (f, h, k, l, m, n, p, t, C, J) {
            ...
            if ("jsonp" === L(f)) var M = c.createCallback(h), w = e(h, M, function (a, b) {
                ...
                N.onload = function () {
                    var a = N.statusText || "", b = "response" in N ? N.response : N.responseText,
    ...
    function vf() {
        ...
        this.$get = ["$parse", "$exceptionHandler",
            "$sce", function (d, c, f) {
                ...
                var l = a.length, m = b.length, n = new RegExp(a.replace(/./g, e), "g"),
        ...
        this.$get = ["$rootScope", "$window", "$q", "$$q", "$browser", function (a, b, d, c, f) {
            function e(e, k, l, m) {
                ...
                var p = 4 < arguments.length, t = p ? wa.call(arguments, 4) :
                    [], C = b.setInterval, q = b.clearInterval, s = 0, M = u(m) && !m, w = (M ? c : d).defer(),
                    r = w.promise;
                l = u(l) ? l : 0;
    ...
    function Df() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", "$window", function (d, c, f, e, g) {
            ...
            d.$watch(function () {
                var a = lb(c.url()), b = lb(l.absUrl()), e = c.state(), g = l.$$replace,
    ...
    function Lf() {
        this.$get = ["$window", "$document", function (a, b) {
            var d = {},
                ...
                e = /Boxee/i.test((a.navigator || {}).userAgent), g = b[0] || {}, h = g.body && g.body.style, k = !1,
                l = !1;
    ...
    var Mg = /^\/(.+)\/([a-z]*)$/, va = Object.prototype.hasOwnProperty, L = function (a) {
        ...
        }, La, F, na, wa = [].slice, mg = [].splice, Ng = [].push, la = Object.prototype.toString,
        Fc = Object.getPrototypeOf, Ga = H("ng"), Z = A.angular || (A.angular = {}), Yb, qb = 0;
    ...
    var G = Array.isArray,
        ...
        }(A.document), se = /[A-Z]/g, Nc = !1, Ja = 3,
        xe = {full: "1.6.0", major: 1, minor: 6, dot: 0, codeName: "rainbow-tsunami"};
    U.expando = "ng339";
    var ib = U.cache = {}, Zf = 1;
    U._data = function (a) {
        return this.cache[a[this.expando]] || {}
    };
    var Vf = /-([a-z])/g, Og = /^-ms-/, zb = {mouseleave: "mouseout", mouseenter: "mouseover"}, $b = H("jqLite"),
        Yf = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, Zb = /<|&#?\w+;/, Wf = /<([\w:-]+)/,
        Xf = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:-]+)[^>]*)\/>/gi, oa = {
    ...
    var Tf = [function () {
        ...
        }], fg = /^([^(]+?)=>/, gg = /^[^(]*\(\s*([^)]*)\)/m, Pg = /,/, Qg = /^\s*(_?)(\S+?)\1\s*$/,
        eg = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, ca = H("$injector");
    ...
    var fd = /^((?:x|data)[:\-_])/i,
        ...
        }, nd = "application/json", jc = {"Content-Type": nd + ";charset=utf-8"}, og = /^\[|^\{(?!\{)/,
    ...
    var ua = H("$sce"), qa = {HTML: "html", CSS: "css", URL: "url", RESOURCE_URL: "resourceUrl", JS: "js"},
    ...
    var be = function (a) {
        ...
        Me = be(!0), Jg = /^\d{4,}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+(?:[+-][0-2]\d:[0-5]\d|Z)$/,
        ...
        Kg = /^\s*(-|\+)?(\d+|(\d*(\.\d*)))([eE][+-]?\d+)?\s*$/, ce = /^(\d{4,})-(\d{2})-(\d{2})$/,
    ...
    var ef = function () {
        ...
        }, Re = Ra({terminal: !0, priority: 1E3}), Zg = H("ngOptions"),
        ...
        Ze = ["$compile", "$document", "$parse", function (a, b, d) {
                ...
                return {
                    trackBy: r, getTrackByValue: w, getWatchables: d(K, function (a) {
                        ...
                        for (var a = [], b = {}, d = K(c) || [], g = f(d), h = g.length, n = 0; n < h; n++) {
                            var p = d === g ? n : g[n], q = B(d[p], p), s = v(c, q), p = u(s, q), t = x(c, q),
                                y = A(c, q), q =
            ...
            return {
                link: function (e,
                    ...
                    var l = h.count, m = h.$attr.when && g.attr(h.$attr.when), n = h.offset || 0, p = e.$eval(m) || {},
                        r = {}, u = b.startSymbol(), y = b.endSymbol(), s = u + l + "-" + n + y, A = Z.noop, w;
                    q(h, function (a, b) {
                        var c = f.exec(b);
        ...
        $e = ["$compile", function (a) {
            ...
            e.removeOption = function (a) {
                var b = g.get(a);
                b && (1 === b ? (g.remove(a), "" === a && (e.hasEmptyOption =
